...
#### Treatment of multiple series IDs and displays
...
Illustrated instructions for using this plugin can be found on the [User Documentation page](user_documentation/USER_DOCUMENTATION.md).
